...
export default function TodayPage() {
  ...
  const { allHabits, habitsLoading, handleToggleHabit, feelings, influences, handleSaveMood } = useHabits();
  ...
  const { modalState, handleCloseModal, formState, setFormState } = useUI();
  ...
  return (
    ...
    <div className="flex flex-col gap-6">
      ...
      <Dialog open={modalState.type === 'mood'} onOpenChange={(open) => { if (!open) handleCloseModal('mood'); }}>
